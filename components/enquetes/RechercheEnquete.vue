    ...
    >
      ...
      <v-col md="6" lg="6" sm="12" class="mb-0 pb-0 d-flex">
        <v-text-field  
          ...
          placeholder="Annnée, Monnaie, Structure, etc."
          clearable
      ...
      <v-col md="6" lg="6" sm="12">
        <v-text-field
          v-show="false"
          label="investissement ID"
          outlined dense
          desabled
          v-model="model.investissement_id"
        ></v-text-field>
      </v-col>-->
      <!-- <v-col
        lg="6"
  ...
  export default {
     ...
     typeProfils: [{
      ...
      model: {
       ...
       rules:{
        ...
        investissement_idRules: [
         v => /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/ || 'investissement incorrecte',
        ]
      },
    ...
    methods: {
      ...
      submitForm () {
        ...
        this.$store.commit('investissements/initdatasearch',this.model.dataSearch)
      ...
      getList(){
        this.page=1
        this.progress=true
        this.$store.dispatch('investissements/getDataSearch',null)
         this.$msasApi.$get('/investissements?page=1')
        .then(async (response) => {
          this.page=1
