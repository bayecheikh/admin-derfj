  ...
  export default {
    ...
    methods: {
      ...
      submitForm () {
        ...
        this.$store.commit('donnee_bases/initdatasearch',this.model.dataSearch)
      ...
      getList(){
        this.page=1
        this.progress=true
        this.$store.dispatch('donnee_bases/getDataSearch',null)
         this.$msasApi.$get('/donnee_bases?page=1')
        .then(async (response) => {
          this.page=1
      ...
      getResult(page,param){
        this.page=1
         this.progress=true
         this.$msasApi.get('/donnee_bases-multiple-search/'+param+'?page='+page)
          .then(async (response) => {
