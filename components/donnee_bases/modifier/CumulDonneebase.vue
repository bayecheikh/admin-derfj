                ...
                <v-row>
                  <v-col md="12" lg="12" sm="12">
                    <v-radio-group
                      ...
                      row
                    >
                    Ind. R.3.1.1 : Mise en place de l’assistance technique en structuration de chaînes de valeur : &nbsp; &nbsp;
                ...
                <v-row>
                  <v-col md="12" lg="12" sm="12">
                    <v-radio-group
                      ...
                      row
                    >
                    Ind. R.3.1.2 : Les capacités de la DER sont renforcées en recouvrement,CSIG : &nbsp; &nbsp;
