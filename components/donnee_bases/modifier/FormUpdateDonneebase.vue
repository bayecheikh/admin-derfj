...
import { mapMutations, mapGetters } from 'vuex'
  export default {
    ...
    computed: 
      mapGetters({
      detaildonnee_base:'donnee_bases/detaildonnee_base',
    ...
    methods: {
      getDetail(id){
          this.progress=true
          this.$msasApi.$get('/donnee_bases/'+id)
        .then(async (response) => {
            console.log('Detail ++++++++++',response)
            this.$store.dispatch('donnee_bases/getDetail',response.data)
      ...
      submitForm () {
        let validation = this.$refs.form.validate()
          ...
          validation && this.$msasFileApi.post('/donnee_bases/'+this.$nuxt._route.params.id,formData)
            .then((res) => {           
