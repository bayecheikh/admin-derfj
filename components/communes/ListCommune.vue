  ...
  <div>
    ...
    <v-tabs-items v-model="tab">
      <v-tab-item v-for="item in tabItems"  :key="item.value" >
          <table-commune :tab="item.value"></table-commune> 
      </v-tab-item>          
    </v-tabs-items>
  </div>
</template>
<script>
import TableCommune from '@/components/communes/TableCommune'
  export default {
    components: {
      TableCommune
    },
    ...
    methods:{
      goToAddCommune() {      
        this.$router.push('/communes/addCommune');
      },
    }
  }
</script>
