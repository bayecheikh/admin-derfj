  ...
  export default {
    ...
    methods: {
      ...
      submitForm () {
        ...
        this.$store.commit('cible_fin_projets/initdatasearch',this.model.dataSearch)
      ...
      getList(){
        this.page=1
        this.progress=true
        this.$store.dispatch('cible_fin_projets/getDataSearch',null)
         this.$msasApi.$get('/cible_fins?page=1')
        .then(async (response) => {
          this.page=1
      ...
      getResult(page,param){
        this.page=1
         this.progress=true
         this.$msasApi.get('/cible_fins-multiple-search/'+param+'?page='+page)
          .then(async (response) => {
