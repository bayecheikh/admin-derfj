<template>
    ...
    <div class="custom-container mt-5">
      ...
      <v-row class="d-flex justify-content-between">
        <v-col md="12" sm="12" lg="12" class="text-sm-center bg-grey-2 my-5">
          <h2 class="text-grey">Taux de réalisation(en %)</h2>
        </v-col>
  ...
  import { mapMutations, mapGetters } from 'vuex'
    ...
    export default {
      ...
      methods: {
        getResultatAttendu(){
          this.$msasApi.$get('/allDonneeBase')
          .then(async (response) => { 
            console.log('Données reçu cible annuelle -------- +++++++++++',response)
        ...
        getResultatAtteint(){
          ...
          .then(async (response) => { 
            console.log('Données reçu resulat atteint sectoriel -------- +++++++++++',response)
                ...
                this.model = {      
                  "Ind_1" : this.modelAttendu.Ind_1?Ind_1/this.modelAttendu.Ind_1*100:0,
                  "Ind_2" : this.modelAttendu.Ind_2?Ind_2/this.modelAttendu.Ind_2*100:0,
                  "Ind_1_1" : this.modelAttendu.Ind_1_1?Ind_1_1/this.modelAttendu.Ind_1_1*100:0,
                  "Ind_2_1" :this.modelAttendu.Ind_2_1?Ind_2_1/this.modelAttendu.Ind_2_1*100:0,
                  "Ind_R_3_1_1" :this.modelAttendu.Ind_R_3_1_1?Ind_R_3_1_1/this.modelAttendu.Ind_R_3_1_1*100:0,
                  "Ind_R_3_1_2" : this.modelAttendu.Ind_R_3_1_2?Ind_R_3_1_2/this.modelAttendu.Ind_R_3_1_2*100:0,
                  "Ind_R_3_2_1" : this.modelAttendu.Ind_R_3_2_1?Ind_R_3_2_1/this.modelAttendu.Ind_R_3_2_1*100:0,
                  "Ind_R_3_2_2" : this.modelAttendu.Ind_R_3_2_2?Ind_R_3_2_2/this.modelAttendu.Ind_R_3_2_2*100:0 ,

                  "Ind_1_2" : this.modelAttendu.Ind_1_2?Ind_1_2/this.modelAttendu.Ind_1_2*100:0,
                  "Ind_R_1_2_1" :this.modelAttendu.Ind_R_1_2_1?Ind_R_1_2_1/this.modelAttendu.Ind_R_1_2_1*100:0,
                  "Ind_R_1_1_2" :this.modelAttendu.Ind_R_1_1_2?Ind_R_1_1_2/this.modelAttendu.Ind_R_1_1_2*100:0,
                  "Ind_R_1_1_1" :this.modelAttendu.Ind_R_1_1_1?Ind_R_1_1_1/this.modelAttendu.Ind_R_1_1_1*100:0,
                  "Ind_2_2" :this.modelAttendu.Ind_2_2?Ind_2_2/this.modelAttendu.Ind_2_2*100:0,
                  "Ind_R_1_2_2" :this.modelAttendu.Ind_R_1_2_2?Ind_R_1_2_2/this.modelAttendu.Ind_R_1_2_2*100:0,
                  "Ind_R_2_2_2" : this.modelAttendu.Ind_R_2_2_2?Ind_R_2_2_2/this.modelAttendu.Ind_R_2_2_2*100:0,
                  "Ind_R_2_2_1" :this.modelAttendu.Ind_R_2_2_1?Ind_R_2_2_1/this.modelAttendu.Ind_R_2_2_1*100:0, 	
                  "Ind_R_1_1_1" :this.modelAttendu.Ind_R_1_1_1?Ind_R_1_1_1/this.modelAttendu.Ind_R_1_1_1*100:0, 
                  "Ind_R_2_1_1" :this.modelAttendu.Ind_R_2_1_1?Ind_R_2_1_1/this.modelAttendu.Ind_R_2_1_1*100:0
                }
              }).catch((error) => {
                  console.log('Code error ++++++: ', error?.response?.data?.message)
              }).finally(() => {
        ...
        // this.updateAtteint(value,'annee')
         this.updateAttendu(value,'annee')
        },
        ...
        async updateAttendu(value,type) {
          var list = []
          if(type=='annee'){
            this.annee = value
            if(this.trimestre=='' && this.secteur=='')
            list = this.listresultatAttendus.filter((item) =>(item.annee==value))
            if(this.trimestre!='' && this.secteur=='')
            list = this.listresultatAttendus.filter((item) =>(item.annee==value && (parseInt(item.trimestre.slice(-1))<=parseInt(this.trimestre.slice(-1)))))
            if(this.trimestre=='' && this.secteur!='')
            list = this.listresultatAttendus.filter((item) =>(item.annee==value && item.secteur==this.secteur))
            if(this.trimestre!='' && this.secteur!='')
            list = this.listresultatAttendus.filter((item) =>(item.annee==value && item.secteur==this.secteur && (parseInt(item.trimestre.slice(-1))<=parseInt(this.trimestre.slice(-1)))))
          }
           
          if(type=='trimestre'){
            
            this.trimestre = value
            console.log("+++Item filtre trimestre : ",(this.listresultatAttendus[0].trimestre.slice(-1)))
            list = this.listresultatAttendus.filter((item) =>(parseInt(item.trimestre.slice(-1))<=parseInt(value.slice(-1))))
            if(this.annee!='' && this.secteur=='')
            list = this.listresultatAttendus.filter((item) =>((parseInt(item.trimestre.slice(-1))<=parseInt(value.slice(-1))) && item.annee==this.annee))
            if(this.annee=='' && this.secteur!='')
            list = this.listresultatAttendus.filter((item) =>((parseInt(item.trimestre.slice(-1))<=parseInt(value.slice(-1))) && item.secteur==this.secteur))
            if(this.annee!='' && this.secteur!='')
            list = this.listresultatAttendus.filter((item) =>((parseInt(item.trimestre.slice(-1))<=parseInt(value.slice(-1))) && item.annee==this.annee && item.secteur==this.secteur))
          }
          
          if(type=='secteur'){
            this.secteur = value
            list = this.listresultatAttendus.filter((item) =>(item.secteur==value))
            if(this.annee!='' && this.trimestre=='')
            list = this.listresultatAttendus.filter((item) =>(item.secteur==value && item.annee==this.annee))
            if(this.annee=='' && this.trimestre!='')
            list = this.listresultatAttendus.filter((item) =>(item.secteur==value && (parseInt(item.trimestre.slice(-1))<=parseInt(this.trimestre.slice(-1)))))
            if(this.annee!='' && this.trimestre!='')
            list = this.listresultatAttendus.filter((item) =>(item.secteur==value && item.annee==this.annee && (parseInt(item.trimestre.slice(-1))<=parseInt(this.trimestre.slice(-1)))))
          }
