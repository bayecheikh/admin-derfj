    ...
    >
      ...
      <v-col md="6" lg="6" sm="12" class="mb-0 pb-0 d-flex">
        <v-text-field  
          ...
          placeholder="Ref projet, Prénom beneficiairen Nom, Titre projet, Region, Departement, Commune"
          clearable
      ...
      <v-col md="6" lg="6" sm="12">
        <v-text-field
          v-show="false"
          label="analysegenre ID"
          outlined dense
          desabled
          v-model="model.analysegenre_id"
        ></v-text-field>
      </v-col>-->
      <!-- <v-col
        lg="6"
  ...
  export default {
     ...
     typeProfils: [{
      ...
      model: {
       ...
       rules:{
        ...
        analysegenre_idRules: [
         v => /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/ || 'analysegenre incorrecte',
        ]
      },
    ...
    methods: {
      ...
      submitForm () {
        ...
        this.$store.commit('analysegenres/initdatasearch',this.model.dataSearch)
      ...
      getList(){
        this.page=1
        this.progress=true
        this.$store.dispatch('analysegenres/getDataSearch',null)
         this.$msasApi.$get('/analysegenres?page=1')
        .then(async (response) => {
          this.page=1
      ...
      getResult(page,param){
        this.page=1
         this.progress=true
         this.$msasApi.get('/analysegenres-multiple-search/'+param+'?page='+page)
          .then(async (response) => {
