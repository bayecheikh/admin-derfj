  ...
  export default {
     ...
     typeProfils: [{
      ...
      model: {
       ...
       rules:{
        ...
        analyserisque_idRules: [
         v => /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/ || 'analyserisque incorrecte',
        ]
      },
    ...
    methods: {
      ...
      submitForm () {
        ...
        this.$store.commit('analyserisques/initdatasearch',this.model.dataSearch)
      ...
      getList(){
        this.page=1
        this.progress=true
        this.$store.dispatch('analyserisques/getDataSearch',null)
         this.$msasApi.$get('/analyserisques?page=1')
        .then(async (response) => {
          this.page=1
      ...
      getResult(page,param){
        this.page=1
         this.progress=true
         this.$msasApi.get('/analyserisques-multiple-search/'+param+'?page='+page)
          .then(async (response) => {
