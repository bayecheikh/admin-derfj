  ...
  export default {
    ...
    methods: {
      ...
      submitForm () {
        ...
        this.$store.commit('beneficiaires/initdatasearch',this.model.dataSearch)
      ...
      getList(){
        this.page=1
        this.progress=true
        this.$store.dispatch('beneficiaires/getDataSearch',null)
         this.$msasApi.$get('/beneficiaires?page=1')
        .then(async (response) => {
          this.page=1
        ...
        console.log('total items++++++++++',this.paginationBeneficiaire)
      },
